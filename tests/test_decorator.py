...
def test_func_without_decorator():
    ...
    assert func(context, **kwargs) == (
        "http://example.org/",
        "GET",
        "7e8f65c7-24e3-4739-b7f2-1286d0d36fa3",
        ["yes", 4711],
        True,
    )
...
def test_func_with_kwargs(value):
    ...
    def func(context, **input_kwargs):
        ...
        return (
            ...
            input_kwargs["method"],
            input_kwargs["id_"],
            [input_kwargs["global_"], input_kwargs["syntax_"]],
            "credentials" not in input_kwargs,
        )
...
def test_wrapped_func(value):
    ...
    assert wrapped_func(context, **kwargs) == (
        "http://example.org/",
        "GET",
        "7e8f65c7-24e3-4739-b7f2-1286d0d36fa3",
        ["yes", 4711],
